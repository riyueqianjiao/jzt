...
<head lang="en">
    ...
    <title>聚职团商家中心--聚天下兼职，我们组团去！</title>
...
<div id="center" class="clearfix">
	<div id="center-l" class="pull-left col-md-2">
		...
		<ul class="ul-out list-unstyled" ng-controller="employer.ctrl">
			<li>
				<p ng-click="vm.unfold(0)">商家功能</p>
				<ul class="ul-inner list-unstyled">
					<li ng-class="{active:vm.iNow==0}" ng-click="vm.iNow=0"><a ng-href="#fbzw">发布新职位</a></li>
		            <li ng-class="{active:vm.iNow==1}" ng-click="vm.iNow=1"><a ng-href="#yfbzw">已发布活动</a></li>
		            <li ng-class="{active:vm.iNow==2}" ng-click="vm.iNow=2"><a ng-href="#yqxzw">已取消活动</a></li>
		            <li ng-class="{active:vm.iNow==5}" ng-click="vm.iNow=5"><a ng-href="#ywjzw">已结束活动</a></li>
		            <li ng-class="{active:vm.iNow==3}" ng-click="vm.iNow=3"><a ng-href="#info">完善公司信息</a></li>
				</ul>
			</li>
			<li>
				<p ng-click="vm.unfold(1)">系统设置</p>
				<ul class="ul-inner list-unstyled">
					<li ng-class="{active:vm.iNow==4}" ng-click="vm.iNow=4"><a ng-href="#updatePass">修改密码</a></li>
				</ul>
			</li>
		</ul>
	</div>
...
<script src="<%=basePath %>/js/module/employerMain.js"></script>
<script src="<%=basePath %>/js/directive/employerdirective.js"></script>
<script src="<%=basePath %>/js/directive/ie.select.js"></script>
<script src="<%=basePath %>/js/route/erroute.js"></script>
