...
<body  ng-controller="employee.login.ctrl">
    ...
    <form name="loginForm" novalidate>
        <div class="login-form">
            ...
            <div class="input-out">
               ...
               <input type="text" class="inputClass" value="" name="phone" ng-model="vm.phone" placeholder="手机号" ng-minlength="11" maxlength="11" autocomplete="off" ng-pattern="/^[0-9]{11}/" ng-keyup="vm.keyUp($event)" required/>
            </div>
            <span>密码</span>
            <div class="input-out">
                <i class="icon-key"></i>
                <input type="password" class="inputClass" value="" name="password" ng-model="vm.password" ng-minlength="6" placeholder="密码" autocomplete="off" ng-keyup="vm.keyUp($event)" required/>
            </div>
            ...
            <div class="autoLogin">
                <a href="register" target="_blank">注册</a>|<a href="<%=basePath%>/employee/retrievePass" target="_blank">忘记密码？</a>
            </div>
            <a href="javascript:;" class="btn btn-login" ng-click="vm.submit()">登&nbsp;&nbsp;&nbsp;&nbsp;录</a>
        </div>
        </form>
    </div>
</div>
